...
namespace MvcKutuphane.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult LinqKart()
        {
            ...
            var deger7 = db.TBLKITAP.GroupBy(x => x.YAYINEVI).OrderByDescending(z => z.Count()).Select(y => new { y.Key }).FirstOrDefault();
            var deger8 = db.TBLKITAP.Where(x => x.DURUM == false).Count();
            ViewBag.dgr1 = deger1;
            ViewBag.dgr2 = deger2;
            ViewBag.dgr3 = deger3;
            ViewBag.dgr4 = deger4;
